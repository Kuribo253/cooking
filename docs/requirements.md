...
| 2025-01-11 | ゲーム詳細仕様を追加 | ストーリー統合、主人公設定、カードシステムの詳細を追加。food/drinkカードによる独自のコンボシステムを導入。 |
...
### 1.1 ストーリーとゲームの統合
- 日常編の中でとある人物との会話で行きたいダンジョンを選択
- 選択後、ダンジョン編へ移行
- ストーリーの進行によってダンジョンがアンロックされる
...
#### 6.3.1 フード（Food）カードシステム
- コストを支払うのではなく、コストを生成する特殊カード
- 例：
  - **木の実**: 0コスト、効果：1コストを得る
  - **おにぎり**: 0コスト、効果：手札を1枚捨てて2コストを得る

#### 6.3.2 ドリンク（Drink）カードシステム
- フードカードとのコンボで追加効果を発動
- 例：
  - **水**: 0コスト、1枚捨てる。木の実を食べたターンの場合、1コストを得る
  - **お茶**: 0コスト、1枚引く。おにぎりを食べたターンの場合、1コストを得る
